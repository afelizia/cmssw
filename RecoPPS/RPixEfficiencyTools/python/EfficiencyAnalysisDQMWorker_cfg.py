...
options.register('outputFileName',
            'outputEfficiencyAnalysisDQMWorker_provaReduced_56.root',
...
tagSuffix = '' # only if using ALCAPPS datasets, otherwise it should be ''
trackTag += tagSuffix
protonTag += tagSuffix
l1digiTag += tagSuffix
...
process.worker = DQMEDAnalyzer('EfficiencyTool_2018DQMWorker',
   ...
   # triggerPattern = cms.string("HLT_PPSMaxTracks*"),
